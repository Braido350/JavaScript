(function(){
  ...
  */
  ...
  var myName = 'Paulo Gabriel Prando Braido'
  console.log(text.replace('Manuel Marques de Sousa', myName));
  ...
  */
  ...
  var myCidade = 'ariquemense'
  console.log(text.replace('brasileiro', myCidade))
  ...
  */
  ...
  var numTraco = '-'
  console.log(text.replace(/\d/g, numTraco))
  ...
  */
  ...
  var result = text.replace(/O Centauro de Luvas/g, function(match){
  ...
  */
  ...
  function getMonthNumber(monthName) {
      ...
      var normalizedMonth = monthName.toLowerCase();
    
      return months[normalizedMonth] || '00';
    }
  ...
  */
  ...
  var regexDate = /(\d{1,2}) de (\w{4,8}?) de (\d{4})/g;
  ...
  */
  ...
  function replaceDate(match, p1, p2, p3) {
      const day = p1;
      const month = getMonthNumber(p2);
      const year = p3;
    
      return `${day}/${month}/${year}`;
    }
      const textoOriginal = "13 de maio de 1804, 25 de junho de 1900, 8 de dezembro de 2022";
    const textoModificado = textoOriginal.replace(regexDate, replaceDate);
