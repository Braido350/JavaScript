...
*/
var arr = [1, {i : 0}, function i(){ console.log("Helo Word")}, [1, 2], "10" ]
...
*/
console.log("O segundo elemento do segundo array é "+ arr[5][1] +".") //O segundo elemento do segundo array é Item 2.
